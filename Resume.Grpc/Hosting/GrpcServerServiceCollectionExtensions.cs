...
{
    public static class AGrpcServerServiceCollectionExtensions
    {
        /// <summary>
        ...
        {
            if (!serviceCollection.Any(s => s.ServiceType.Equals(typeof(IHostedService)) && s.ImplementationType.Equals(typeof(ResumeGrpcHostedService))))
            {
                serviceCollection.AddSingleton<IHostedService, ResumeGrpcHostedService>();
            }
        }
    }
}
